...
/////////////////////////////////////////////////////////
	public function index(){
		...
		if(!isset($_GET['ind'])){
			redirect(site_url('login?ind=assessment2023'));
		} else {
				$session_data = $this->session->userdata('logged_in');
				$data['sesi'] = (ISSET($session_data['back_office']));
				...
				$data['ind'] = $inx;
				$data['ccn'] = $snx;
				$data['aksi'] = ($_GET['ind']=="aswtech")?"sama":"dologin";
		
				$this->viewPath = '../../assets/themes/Login_v1/';
