...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'log_bkkbn.png')) {
		$tcpdf_header_logo = 'log_bkkbn.png';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'aSwTeCH');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'aSwTeCH');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'ASSESSMENT CENTER');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "Badan Kependudukan dan \nKeluarga Berencana Nasional");
}

if (!defined('PDF_HEADER_STRING_RIGHT')) {
	define ('PDF_HEADER_STRING_RIGHT', "RAHASIA");
}
