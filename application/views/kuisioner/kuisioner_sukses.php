...
<section class="section contact-me" data-section="section1">
    <div class="container">
        ...
        <div class="registrasi">
			<h2 class="fs-title">T E R I M A  K A S I H <br/></h2>
			<h3 class="fs-subtitle">Saudara telah menyelesaikan rangkaian Uji Kompetensi</h3>
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<button type="button" style="width:100%;" onclick="closeWindow();">Close</button>
					</div>
				</div>	
            </div>
        </div>
