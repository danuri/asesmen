            ...
            <div class="col-md-12">
				<div class="right-content">
					<div class="container">
						...
						<div class="reg-item ">
						<h2 class="fs-title">Data tidak ditemukan</h2>
						<div class="tab">
							<p style="color:#fff;font-size:12px">Pastikan Saudara memasukan NIP 18 Digit dan <b>tanpa menggunakan spasi</b></p>
						</div>
						<div style="overflow:auto;">
							<div style="float:right;">
								<div class="btn btn-danger btn-xs pull-right " onclick="history.go(-1); return false;"><i class="fa fa-backward fa-fw"></i> Kembali</div>
							</div>
						</div>
						</div>  
						</form>
