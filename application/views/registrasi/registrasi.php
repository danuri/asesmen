					...
					<div class="container">
						...
						<h3 class="fs-subtitle">Penulisan menggunakan huruf kapital</h3>
							...
							if(count($caridata)>0){
								...
								{
									header("Location: https://sapa-ac.bkkbn.go.id/registrasi/search_failed");
									exit();
									//echo 'data ga ada';
								}
							?>	
						...
						<h3 class="fs-subtitle">Pendidikan Awal diangkat CPNS dan terakhir yang diakui secara kepegawaian</h3>
							<div class="row">
								...
								<p class="help-block" style="color:#fff;">Pendidikan Awal CPNS.</p>
									...
									<p>
										<p class="help-block" style="color:#fff;">Tahun ( Hanya masukan tahun lulus, contoh : 1998 )</p>
						...
						<h3 class="fs-subtitle">Riwayat Jabatan 2 (dua) Kali Sebelum Jabatan Saat ini.</h3>
							<div class="row">
								...
								<p class="help-block" style="color:#fff;">Riwayat Jabatan 1</p>
									...
									<p>
										<p class="help-block" style="color:#fff;">Tahun ( Hanya masukan rentang tahun, contoh : 2010 - 2015 )</p>
										<textarea class="form-control" placeholder="Contoh : 2010 - 2015" oninput="this.className = ''" name="thn_unker_1"></textarea>
									</p>
								</div>
								...
								<p class="help-block" style="color:#fff;">Riwayat Jabatan 2</p>		
									...
									<p>
										<p class="help-block" style="color:#fff;">Tahun ( Hanya masukan rentang tahun, contoh : 2010 - saat ini )</p>
										<textarea class="form-control" placeholder="Contoh : 2010 - Sekarang" oninput="this.className = ''" name="thn_unker_2"></textarea>
									</p>
								</div>
							</div>
						</div>
					...
					<table border="1px" cellpadding="5px" cellspacing="5px">
						...
						<h2 class="fs-title">Tahap 16 : Q - Kompetensi (8)</h2>
							...
							<table border="1px" cellpadding="5px" cellspacing="5px">
								...
								<div class="col-md-6">
									<p>
										<p class="help-block" style="color:#fff;"><b>(Pertanyaan ini Khusus JPT Pratama / Eselon II, bagi yang tidak termasuk berikan tanda "strip")</b><br/>(15.) Ceritakan alasan Saudara mengikuti seleksi pimpinan tinggi pratama ini! Jabatan satuan kerja  apa yang Saudara pilih?</p>
						...
						<h2 class="fs-title">Tahap 17 : Q - Kompetensi (9)</h2>
							...
							<table border="1px" cellpadding="5px" cellspacing="5px">
								...
								<div class="col-md-6">
									<p>
										<p class="help-block" style="color:#fff;"><b>(Pertanyaan ini Khusus JPT Pratama / Eselon II, bagi yang tidak termasuk berikan tanda "strip")</b><br/>(16.) Menurut Saudara apa saja kompetensi yang di butuhkan dalam jabatan yang Saudara pilih? Mengapa kompetensi itu dibutuhkan?</p>
										<textarea class="form-control" placeholder="Tuliskan jawaban saudara disini" oninput="this.className = ''" name="jwb16"></textarea>
									</p>
								</div>	
								<div class="col-md-6">
									<p>
										<p class="help-block" style="color:#fff;"><b>(Pertanyaan ini Khusus JPT Pratama / Eselon II, bagi yang tidak termasuk berikan tanda "strip")</b><br/>(17.) Apa kompetensi yang Saudara miliki? Apakah kompetensi yang Saudara miliki sudah cukup sesuai dengan target jabatan Saudara?</p>
