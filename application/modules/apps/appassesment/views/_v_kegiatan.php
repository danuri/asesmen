...
        }
		...
		$('#btn_simpan').on('click',function(){
            ...
            $.ajax({
                ...
                dataType : "JSON",
                data : {kd_kegiatan:kd_kegiatan, nama_kegiatan:nama_kegiatan, jenis_kegiatan:jenis_kegiatan, instansi:instansi, tgl_keg:tgl_keg, ket:ket, tahun:tahun, link_doc:link_doc},
                success: function(data){
