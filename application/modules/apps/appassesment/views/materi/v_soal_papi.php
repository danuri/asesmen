...
            $.ajax({
				type  : 'POST',
                url   : '<?php echo site_url('appassesment/soal/soal_papi');?>',
                async : false,
                dataType : 'json',
...
                        html += '<tr>'+
								...
								'<i class=""> '+no+'</i></button>'+
									'<ul class="dropdown-menu" role="menu">'+
										'<li role="presentation"><a href="javascript:;" class="btn btn-secondary pull-left item_edit" data="'+data[i].id_papi+'" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-pencil"></i> Edit</a></li>'+' '+
										'<li role="presentation"><a href="javascript:;" class="btn btn-secondary pull-left item_hapus" data="'+data[i].id_papi+'" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-trash"></i> Hapus</a></li>'+' '+
									...
									'</ul>'+
								'</td></div>'+
                                '<td>'+data[i].soal_papi_a+'</td>'+
                                '<td>'+data[i].soal_papi_b+'</td>'+
