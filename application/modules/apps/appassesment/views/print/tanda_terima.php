...
$pdf->Ln(30);
$pdf->Write(0, 'TANDA TERIMA SURAT PERINTAH TUGAS', '', 0, 'C', true, 0, false, false, 0);
$pdf->Ln(7);
...
<table border="1px">
    <tr>
        ...
        <th style="width:230px;height:25px;text-align:center;"><b>Nama</b></th>
        <th style="width:220px;height:25px;text-align:center;"><b>Jabatan</b></th>
        <th style="width:170px;height:25px;text-align:center;"><b>Tanda Tangan</b></th>
    </tr>
</table>
EOD;
...
<table border="1px">
	<tr>
		...
		<td style="width:230px;">$val->nama<br/> NIP. $val->nip</td>
		<td style="width:220px;">$val->jabatan<br/>pada $val->unker</td>
		<td style="width:170px;text-align:center;display: table-cell;vertical-align: baseline;"></td>
	</tr>
</table>
EOD;
// output the HTML content
