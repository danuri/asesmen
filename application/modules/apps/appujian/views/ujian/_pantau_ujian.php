			...
			<div class="tab-content">
				...
				<div class="tab-pane fade" id="apm2-pills">
					<div class="panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
							<div class="btn btn-default btn-xs pull-right"></div><a href="<?php echo base_url();?>appassesment/jadwal_peserta/lihat_apm_dua/" data-toggle="modal" data-target="#ModalaAPM2" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-calculator"></i>&nbsp; Lihat APM Set-2</a></div>
...
                        html += '<tr>'+
								...
								'<i class=""></i> '+no+'</button>'+
									'<ul class="dropdown-menu" role="menu">'+
										'<li role="presentation"><a href="<?php echo base_url();?>appujian/Export_papi/get_hasil_papi/'+data[i].id_peserta_papi+'");" target="_blank" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-download"></i> Download</a></li>'+' '+
									'</ul>'+
								'</td></div>'+
                                '<td style="width:25%">'+data[i].nama+' <br/> NIP. <b>'+data[i].nip+'</b></td>'+
                                '<td style="width:20%">'+data[i].gol+' <br/> <b>'+data[i].jenjang+'</b></td>'+
...
                        html += '<tr>'+
								...
								'<i class=""></i> '+no+'</button>'+
									'<ul class="dropdown-menu" role="menu">'+
										'<li role="presentation"><a href="<?php echo base_url();?>appujian/pantau_ujian/lihat_ankas/'+data[i].id_peserta_ankas+'");" target="_blank" role="menuitem" tabindex="-1" style="cursor:pointer;"><i class="fa fa-file-pdf-o"></i> Cetak</a></li>'+' '+
									'</ul>'+
								'</td></div>'+
                                '<td style="width:25%">'+data[i].nama+' <br/> NIP. <b>'+data[i].nip+'</b></td>'+
                                '<td style="width:20%">'+data[i].gol+' <br/> <b>'+data[i].jenjang+'</b></td>'+
