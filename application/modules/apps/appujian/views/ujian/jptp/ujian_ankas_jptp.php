...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
			...
			<div class="panel-body">
				<form id="regForm" action="<?php echo base_url('appujian/ujian_jptp/simpan_ujian_ankas');?>" method="post">
					<input type="hidden" name="nip" value="<?=$user;?>"  />
					<input type="hidden" name="ket" value="Y"  />
					<input type="hidden" name="id_materi_ankas" value="17"  />
...
jQuery(function ($) {
    var fiveMinutes = 3600, //2700 --> 45 || 3600 --> 60
        display = $('#time');
...
window.onload=function(){
        var auto = setTimeout(function(){ autoRefresh(); }, 1800000);//1350000 --> 45 || 1800000 --> 60
        ...
        function autoRefresh(){
           clearTimeout(auto);
           auto = setTimeout(function(){ submitform(); autoRefresh(); }, 1800000);//1350000 --> 45 || 1800000 --> 60
        }
    }
