    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
				<i class="glyphicon glyphicon-align-center"></i>&nbsp; Wacana Analisa Kasus
            </div>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
				...
				<div style="float:right;">Waktu Pengerjaan <span id="time">60:00</span> Menit!</div><!-- 45:00  || 60:00-->
            </div>
			<div class="panel-body">
				<form id="regForm" action="<?php echo base_url('appujian/ujian/simpan_ujian_ankas');?>" method="post">
					<input type="hidden" name="nip" value="<?=$user;?>"  />
					<input type="hidden" name="ket" value="Y"  />
					<input type="hidden" name="id_materi_ankas" value="2"  />
						...
						<h4>Petunjuk Pengerjaan !</h4>
							<table width="100%" class="table table-striped table-bordered">
								<tr>
									...
									<td style="text-align:justify;"><p>Bacalah dengan seksama informasi yang terdapat dalam soal, yang terdiri atas : <br>
										a.	Situasi;<br>
										b.	Bahan bacaan; dan<br>
										c.	Tugas anda.
									</p></td>
								</tr>
								<tr>
									<td style="width:30px; text-align:center;">2</td>
									<td style="text-align:justify;"><p>Anda dapat merespon seluruh kondisi kerja tersebut dengan dukungan data atau informasi yang diberikan, atau dapat menggunakan pengalaman, pengetahuan, maupun data atau informasi lain yang anda miliki.</p></td>
								</tr>
								<tr>
									<td style="width:30px; text-align:center;">3</td>
									<td style="text-align:justify;"><p>Anda diminta untuk menjawab 3 (tiga) pertanyaan dengan detail, jelas, dan menggunakan ejaan atau Bahasa Indonesia yang baku agar mudah dipahami oleh pemeriksa.</p></td>
								</tr>
								<tr>
									<td style="width:30px; text-align:center;">4</td>
									<td style="text-align:justify;"><p>Tidak ada jawaban benar atau salah dalam simulasi ini. Anda diminta untuk meresponnya secara individual dan sejujur-jujurnya.</p></td>
								</tr>
								<tr>
									<td style="width:30px; text-align:center;">5</td>
									<td style="text-align:justify;"><p>Tidak diperkenankan menggunakan alat bantu lain untuk mendapatkan data atau informasi yang anda perlukan dalam mengerjakan soal simulasi ini.</p></td>
								</tr>
								<tr>
									<td style="width:30px; text-align:center;">6</td>
									<td style="text-align:justify;"><p>Waktu yang dialokasikan untuk mengerjakan adalah <b>60 menit</b>.</p></td>
								</tr>
								...
								<tr>
									...
									<td style="text-align:justify;font-weight:bold;"><p>Waktu yang diberikan untuk mengerjakan simulasi ini adalah 60 menit</p></td>
								</tr>
								-->
...
function showTab(n) {
  ...
  if (n == (x.length - 1)) {
    document.getElementById("nextBtn").innerHTML = "Simpan & Lanjut Tes Berikutnya";
  } else {
...
jQuery(function ($) {
    var fiveMinutes = 3600, //2700 --> 45 || 3600 --> 60 || 5400 --> 90
        display = $('#time');
...
window.onload=function(){
        var auto = setTimeout(function(){ autoRefresh(); }, 1800000);//1350000 --> 45 || 1800000 --> 60 || 2700000 -> 90
        ...
        function autoRefresh(){
           clearTimeout(auto);
           auto = setTimeout(function(){ submitform(); autoRefresh(); }, 1800000);//1350000 --> 45 || 1800000 --> 60 || 2700000 -> 90
        }
    }
