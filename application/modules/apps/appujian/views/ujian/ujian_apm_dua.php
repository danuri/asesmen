    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
			...
			<div class="panel-body">
				<form id="regForm" action="<?php echo base_url('appujian/ujian/simpan_ujian_apm_dua');?>" method="post">
					...
					<div class="row">
						<div class="col-lg-6">
							...
							<img src="<?php echo base_url(); ?>assets/media/upload/mastersoal/soalapmset2/<?php echo $key->judul_appe; ?>" style="width:480px; height:500px">
						</div>
						<div class="col-lg-3">
							<label>
