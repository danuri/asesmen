...
'
	...
	<table style="border: 1px solid #000; height:20px;">
		...
		<tbody>
			<tr style="border: 1px solid #000; height:20px;">
				<td style="border: 1px solid #000; height:20px;font-style: italic;">Di unit Kerja mana? <br/> <p>'.$d->unker_puas.'</p> <br/> <hr/> Mengapa? <br/> <p>'.$d->alasan_puas.'</p></td>
				<td style="border: 1px solid #000; height:20px;font-style: italic;">Di unit Kerja mana? <br/> <p>'.$d->unker_no_puas.'</p> <br/> <hr/> Mengapa? <br/> <p>'.$d->alasan_no_puas.'</p></td>
			</tr>
		</tbody>
	</table>
			<hr/>
