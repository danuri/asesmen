...
///// UJIAN CFIT
	...
	function cfit_satu(){
		...
		$data['contoh_cfit_satu'] = $this->M_ujian->contoh_cfit_satu($user);
		$data['hasil_contoh_cfit_satu'] = $this->M_ujian->hasil_contoh_cfit_satu();
	...
	function simpan_contoh_cfit_satu(){	
		...
		$jwb_contoh_cfit_4	=$this->input->post('jwb_contoh_cfit_4');
		$jwb_contoh_cfit_5	=$this->input->post('jwb_contoh_cfit_5');
		$jwb_contoh_cfit_6	=$this->input->post('jwb_contoh_cfit_6');
		$ket				=$this->input->post('ket');
		...
		$data = array(
						...
						'jwb_contoh_cfit_4'	=> $jwb_contoh_cfit_4,
						'jwb_contoh_cfit_5'	=> $jwb_contoh_cfit_5,
						'jwb_contoh_cfit_6'	=> $jwb_contoh_cfit_6,
						'ket'				=> $ket );
										
		$this->M_ujian->simpan_contoh_cfit_satu($data,'hasil_contoh_cfit');
		redirect('module/appujian/ujian/cfit_satu');
		
	}
			
	function simpan_ujian_cfit_satu(){	
		$id_peserta_apm_satu		=$this->input->post('id_peserta_apm_satu');
		$nip				=$this->input->post('nip');
		$jwb_apm_satu_1		=$this->input->post('jwb_apm_satu_1');
		$jwb_apm_satu_2		=$this->input->post('jwb_apm_satu_2');
