...
class Ujian_jptp extends MX_Controller {
...
///// UJIAN
	...
	function index(){
		...
		$this->load->view('ujian/jptp/index_jptp',$data);
	}
...
///// UJIAN APM
	...
	function apm_satu(){
		...
		$this->load->view('ujian/jptp/ujian_apm_satu_jptp',$data);
	}
	...
	Public function simpan_ujian_apm_satu(){	
		...
		redirect('module/appujian/ujian_jptp/apm_dua');
	...
	function apm_dua(){
		...
		$this->load->view('ujian/jptp/ujian_apm_dua_jptp',$data);
	}
	...
	Public function simpan_ujian_apm_dua(){
		...
		redirect('module/appujian/ujian_jptp/ankas_jptp');
...
///// UJIAN PAPI
	...
	function papi(){
		...
		$this->load->view('ujian/jptp/ujian_papi_jptp',$data);
	}
	...
	function simpan_ujian_papi(){
		...
		redirect('module/appujian/ujian_jptp/thanks');
	}
...
///// UJIAN ANKAS
	...
	function ankas_jptp(){
		$data['user'] = $this->username;						
		$data['ankas'] = $this->M_ujian->data_ankas_jptp();
		$this->load->view('ujian/jptp/ujian_ankas_jptp',$data);
	}
	...
	function simpan_ujian_ankas(){
		...
		redirect('module/appujian/ujian_jptp/papi');
...
//=======================================================================================================================================	
	...
	function simpan_cfit_empat(){	
		...
		redirect('module/appujian/ujian/ankas_jptp');
