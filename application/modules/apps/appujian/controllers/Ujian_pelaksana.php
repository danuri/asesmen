...
class Ujian_pelaksana extends MX_Controller {
...
///// UJIAN
	...
	function index(){
		...
		$this->load->view('ujian/pelaksana/index_pelaksana',$data);
	}
...
///// UJIAN APM
	...
	function apm_satu(){
		...
		$this->load->view('ujian/pelaksana/ujian_apm_satu_pelaksana',$data);
	}
	...
	Public function simpan_ujian_apm_satu(){	
		...
		redirect('module/appujian/ujian_pelaksana/apm_dua');
	...
	function apm_dua(){
		...
		$this->load->view('ujian/pelaksana/ujian_apm_dua_pelaksana',$data);
	}
	...
	Public function simpan_ujian_apm_dua(){
		...
		redirect('module/appujian/ujian_pelaksana/ankas_pelaksana');
...
///// UJIAN PAPI
	...
	function papi(){
		...
		$this->load->view('ujian/pelaksana/ujian_papi_pelaksana',$data);
	}
	...
	function simpan_ujian_papi(){
		...
		redirect('module/appujian/ujian_pelaksana/thanks');
	}
...
///// UJIAN ANKAS
	...
	function ankas_pelaksana(){
		$data['user'] = $this->username;						
		$data['ankas'] = $this->M_ujian->data_ankas_pelaksana();
		$this->load->view('ujian/pelaksana/ujian_ankas_pelaksana',$data);
	}
	...
	function simpan_ujian_ankas(){
		...
		redirect('module/appujian/ujian_pelaksana/papi');
...
///// UJIAN CFIT
	...
	function contoh_cfit_satu(){
		...
		$this->load->view('ujian/jptp/contoh_cfit_satu',$data);
	}
...
//=======================================================================================================================================	
	...
	function simpan_cfit_empat(){	
		...
		redirect('module/appujian/ujian/ankas_pelaksana');
