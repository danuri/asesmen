<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header">Jenis Widget
		<div class="btn btn-warning btn-xs pull-right content_post" style="margin-top:10px;" onclick="loadForm('formtambah','xx');"><i class="fa fa-plus fa-fw"></i> Tambah Jenis Widget</div>
		</h3>
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->
	...
	<div class="col-lg-12">
		<div class="panel panel-warning" id="panel_utama">
			<div class="panel-heading">
						<div class="row">
								<div class="col-lg-12">
									<i class="fa fa-clipboard fa-fw"></i> Daftar Jenis Widget Website
								</div><!---/.col-lg-12 -->
						</div><!---/.row -->
			</div>
