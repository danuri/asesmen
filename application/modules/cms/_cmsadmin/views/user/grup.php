<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header">Grup Pengguna
		<div class="btn btn-warning btn-xs pull-right content_post" style="margin-top:10px;" onclick="loadForm('formtambahgroup','xx','0','0');"><i class="fa fa-plus fa-fw"></i> Tambah Grup Pengguna</div>
		</h3>
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->
	...
	<div class="col-lg-12">
		<div class="panel panel-warning" id="panel_utama">
			<div class="panel-heading">
						<div class="row">
								<div class="col-lg-12">
									<i class="fa fa-users fa-fw"></i> Daftar Grup Pengguna
								</div><!---/.col-lg-12 -->
						</div><!---/.row -->
			</div>
