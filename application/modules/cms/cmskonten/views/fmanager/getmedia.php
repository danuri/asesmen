...
////////////////tombol treexgrid && variabel kunci-->
				if(item.toggle == "tutup"){
					table = table+ "<td style='padding-left: "+ item.spare +"px;padding-top:1px;padding-bottom:0px;'><div style=\"float:left; padding:1px 5px 0px 0px;\"><i class=\"fa treex fa-folder fa-fw\" style=\"font-size:16px; cursor: pointer;\" data-expand=\"no\"  id='"+item.idchild+"' onclick=\"loadIsiGrid('"+item.idchild+"','"+item.level+"');\"></i></div>"+banyak+ "</td>";
				} else {
