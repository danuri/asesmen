<div class="row">
	<div class="col-lg-12">
		...
		<div class="btn btn-warning btn-xs pull-right content_post" style="margin-top:10px;" onclick="loadForm('formtambah_folder','xx','0','0');"><i class="fa fa-plus fa-fw"></i> Buat Folder</div>
		</h3>
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->
	...
	<div class="col-lg-12">
		<div class="panel panel-warning" id="panel_utama">
			<div class="panel-heading">
						<div class="row">
								<div class="col-lg-6"> 
									<i class="fa fa-book fa-fw"></i> Daftar Folder
								</div><!---/.col-lg-6 -->
						</div><!---/.row -->
			</div>
...
////////////////tombol treexgrid && variabel kunci-->
				if(item.toggle == "tutup"){
					table = table+ "<td style='padding-left: "+ item.spare +"px;'><div style=\"float:left; padding:1px 5px 0px 0px;\"><i class=\"fa treex fa-folder fa-fw\" style=\"font-size:16px; cursor: pointer;\" data-expand=\"no\"  id='"+item.idchild+"' onclick=\"loadIsiGrid('"+item.idchild+"','"+item.level+"');\"></i></div><div>"+item.judul_appe+ "</div></td>";
				} else {
