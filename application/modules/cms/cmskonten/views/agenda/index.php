<div class="row">
	<div class="col-lg-12">
		...
		<div class="btn btn-warning btn-xs pull-right content_post" style="margin-top:10px;" onclick="buka('agenda/formtambah','isi',0);"><i class="fa fa-plus fa-fw"></i> Tambah Konten</div>
			...
			<div class="panel-heading" style="padding-top:2px;padding-bottom:5px;">
						<div class="row">
								<div class="col-lg-8" style="padding-top:8px;">
									<i class="fa fa-puzzle-piece fa-fw"></i> Agenda
								</div><!---/.col-lg-8 -->
...
var id_kat = $('#id_kat').val();
	...
	//tombol aksi-->
					table = table+ "<td valign=top style='padding:3px 0px 0px 0px;'>";
						...
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="buka(\'agenda/formedit\',\'isi\','+item.id_konten+');"><i class="fa fa-edit fa-fw"></i> Edit Data</a></li>';
						if(item.hapus=="ya"){
						table = table+ '<li role="presentation" class="divider">';
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="buka(\'agenda/formhapus\',\'isi\','+item.id_konten+');"><i class="fa fa-trash fa-fw"></i> Hapus Data</a></li>';
						}
						table = table+ "</ul>";
						table = table+ "</div>";
					table = table+ "</td>";
...
var id_katt = $('select[name=id_kat]').val();
	$.ajax({
		...
		data:{"id_konten":id_konten,"id_kat":id_katt,"komponen":"agenda"},
		beforeSend:function(){	
			$('.content_post').hide();
