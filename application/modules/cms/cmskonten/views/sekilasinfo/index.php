<div class="row">
	<div class="col-lg-12">
		...
		<div class="btn btn-warning btn-xs pull-right content_post" style="margin-top:10px;" onclick="buka('sekilasinfo/formtambah',0);"><i class="fa fa-plus fa-fw"></i> Tambah Konten</div>
		</h3>
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->
	...
	<div class="col-lg-12">
		<div class="panel panel-warning" id="panel_utama">
			<div class="panel-heading">
						<div class="row">
								<div class="col-lg-12">
									<i class="fa fa-puzzle-piece fa-fw"></i> Sekilas info
								</div><!---/.col-lg-12 -->
						</div><!---/.row -->
			</div>
...
<th style="width:450px;">JUDUL / ISI</th>
...
var id_kat = $('#id_kat').val();
	...
	//tombol aksi-->
					table = table+ "<td valign=top style='padding:3px 0px 0px 0px;'>";
						...
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="buka(\'sekilasinfo/formedit\','+item.id_appe+');"><i class="fa fa-edit fa-fw"></i> Edit Data</a></li>';
						table = table+ '<li role="presentation" class="divider">';
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="buka(\'sekilasinfo/formhapus\','+item.id_appe+');"><i class="fa fa-trash fa-fw"></i> Hapus Data</a></li>';
						table = table+ "</ul>";
						table = table+ "</div>";
					table = table+ "</td>";
	//tombol aksi<--
					table = table+ "<td style='padding:3px;'><div><h4 style=\'margin:0px;\'>"+item.judul_appe+"</h4></div><small>"+item.keterangan_appe+"</small></td>";
					table = table+ '<td style="padding:3px;">'+item.link+'</td>';
					table = table+ "</tr>";
					no++;
				}); //endeach
					$('#list').html(table);
