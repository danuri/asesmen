<div class="row">
	<div class="col-lg-12">
		...
		<div class="btn btn-warning btn-xs pull-right content_post" style="margin-top:10px;" onclick="buka('banner/formtambah','xx',0);"><i class="fa fa-plus fa-fw"></i> Tambah Konten</div>
		</h3>
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->
	...
	<div class="col-lg-12">
		<div class="panel panel-warning" id="panel_utama">
			<div class="panel-heading">
						<div class="row">
								<div class="col-lg-12">
									<i class="fa fa-puzzle-piece fa-fw"></i> Banner
								</div><!---/.col-lg-12 -->
						</div><!---/.row -->
			</div>
...
var batas = $('#item_lengthA').val();
	...
	//tombol aksi-->
					table = table+ "<td valign=top style='padding:3px 0px 0px 0px;'>";
						...
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="buka(\'banner/formedit\',\'banner\','+item.id_kategori+');"><i class="fa fa-edit fa-fw"></i> Edit Data</a></li>';
						if(item.hapus=="ya"){
						table = table+ '<li role="presentation" class="divider">';
						table = table+ '<li role="presentation"><a role="menuitem" tabindex="-1" style="cursor:pointer;" onClick="buka(\'banner/formhapus\',\'banner\','+item.id_kategori+');"><i class="fa fa-trash fa-fw"></i> Hapus Data</a></li>';
						}
						table = table+ "</ul>";
						table = table+ "</div>";
					table = table+ "</td>";
	//tombol aksi<--
					table = table+ "<td style='padding:3px;'><h4 style=\"margin-top:0px;\">"+item.nama_kategori+"</h4></td>";
