              ...
              <div class='panel panel-info'>
                <div class='panel-heading'>
                  <b>Form <?=$label_aksi;?> Halaman Statis</b>
					<div class="btn btn-primary btn-xs pull-right" onclick="srcEditor(); return false;"><i class="fa fa-cogs fa-fw"></i></div>
					<div class="btn btn-success btn-xs pull-right" onclick="srcHtml(); return false;"><i class="fa fa-list fa-fw"></i></div>
...
function srcHtml(){
	for(isi_konteni in CKEDITOR.instances)	{
		CKEDITOR.instances[isi_konteni].destroy(true);
	}
}
function srcEditor(){
     CKEDITOR.replace('isi_konteni');
