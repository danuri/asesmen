          <div class='row'>
            <div class='col-md-12'>
              <div class='panel panel-<?=isset($hapus)?"danger":"info";?>'>
                <div class='panel-heading'>
                  <b>FORM <?=isset($hapus)?"HAPUS":"EDIT";?> ITEM DIREKTORI</b>
				  <div class="btn btn-warning btn-xs pull-right" onclick="kembali(); return false;"><i class="fa fa-close fa-fw"></i></div>
                </div><!-- /.box-header -->
                <div class='panel-body'>


    <form id="content-form" method="post" action="<?=site_url();?>cmskonten/direktori/<?=isset($hapus)?"hapus":"edit";?>_aksi" enctype="multipart/form-data">
...
<table class="table table-striped">
        ...
        <tr>
          ...
          <td colspan="3">
		  <input type="text" id="nama_direktori" name="nama_direktori"  class="form-control" value="<?=@$ini[0]->judul;?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';" <?=isset($hapus)?"disabled":"";?>>
		  </td>
        </tr>
<?php
$urutan=1;
...
?>
        <tr>
          ...
          <td colspan="3">
		  <input type="text" id='isi_atribut_<?=$urutan;?>' name="isi_atribut[]" class="form-control" value="<?=$nilai;?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';" <?=isset($hapus)?"disabled":"";?>>
...
?>
        <tr>
          <td>Penulis</td>
          <td colspan="3">
												  <select name="id_penulis" id="id_penulis"  class="form-control" <?=isset($hapus)?"disabled":"";?>>
       ...
       <tr >
			<td>&nbsp;</td>
			<td colspan="3">
					<div class="btn btn-<?=isset($hapus)?"danger":"success";?> btn-xl" onclick="simpan(); return false;" id="btAct"><i class="fa fa-<?=isset($hapus)?"trash":"save";?> fa-fw"></i> <?=isset($hapus)?"Hapus":"Simpan";?></div>
