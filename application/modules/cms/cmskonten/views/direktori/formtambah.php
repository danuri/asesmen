...
<table class="table table-striped">
        ...
        <tr>
          ...
          <td colspan="3">
		  <input type="text" id="nama_direktori" name="nama_direktori"  class="form-control" placeholder="Wajib diisi">
		  </td>
        </tr>
<?php
$urutan=1;
...
?>
        <tr>
          ...
          <td colspan="3">
		  <input type="text" id='isi_atribut_<?=$urutan;?>' name="isi_atribut[]" class="form-control" placeholder="Wajib diisi">
