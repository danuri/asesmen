            ...
            <div class='col-md-12'>
              <div class='panel panel-<?=($aksi=="hapus")?"danger":"info";?>'>
                <div class='panel-heading'>
                  <b>FORM <?=strtoupper($aksi);?> ITEM POLLING</b>
				  <div class="btn btn-warning btn-xs pull-right" onclick="kembali(); return false;"><i class="fa fa-close fa-fw"></i></div>
                </div><!-- /.box-header -->
                <div class='panel-body'>
    <form id="content-form" method="post" action="<?=site_url();?>cmskonten/polling/<?=$aksi;?>_aksi" enctype="multipart/form-data">
...
<table class="table table-striped">
        ...
        <tr>
          <td>Keterangan</td>
          <td colspan="3">
		  <input type="text" id="isi" name="isi" class="form-control" value="<?=@$isi->isi_konten;?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';" <?=($aksi=="hapus")?"disabled":"";?>>
		  </td>
        </tr>
        <tr>
...
function validasi_pengikut(opsi){
	...
	var dati="";
			...
			data=data+""+nama+"*"+kket+"**";
			if( nama ==""){	dati=dati+"JUDUL POLLING tidak boleh kosong\n";	}
			if( kket ==""){	dati=dati+"KETERANGAN tidak boleh kosong\n";	}
