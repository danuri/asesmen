...
///////////////////////////////////////////////////////////////////////////////////////////
	...
	function tambah_menu_aksi(){
		$id_parentP = explode("_",$_POST['idparent']);
		$id_parent = end($id_parentP);
...
////////////////////////////////////////////////////////////////////
	function naik_aksi(){
		$id_iniP = explode("_",$_POST['id_ini']);
		$id_ini = end($id_iniP);
		$id_lawanP = explode("_",$_POST['id_lawan']);
		$id_lawan = end($id_lawanP);
