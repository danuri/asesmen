...
///////////////////////////////////////////////////////////////////////////////////
	...
	function getuser(){
		...
		$dt=$this->m_user->hitung_user($path,$cari); 
		...
		if($dt['count']==0){
			...
			$data['hslquery']=$this->m_user->getuser($mulai,$batas,$cari,$path)->result();
			...
			$data['pager'] = Modules::run("crest/pager/pagerC",$dt['count'],$batas,$hal);
		}
...
///////////////////////////////////////////////////////////////////////////////
	...
	function formaktifkan(){
		...
		$data['hslquery']=$this->m_user->detail_user($_POST['user_id']);
		$data['hslqueryb']=$this->m_user->getusergroup();
		$this->load->view('user/formaktifkan_user',$data);
	}
	function aktifkan_aksi(){
		...
		$ang=explode("*",$_POST['nama_user']);
			...
			$ipp['user_name']=$ang[1];
			$ipp['group_id']=$ang[2];
		$proses = $this->m_user->aktifkan_user_aksi($idd,$ipp);
		echo $proses;
	}
	function formnonaktifkan(){
		$data['hal'] = $_POST['hal'];
		$data['batas'] = $_POST['batas'];
		$data['cari'] = $_POST['cari'];
		$data['user_id']=$_POST['user_id'];
		...
		$data['hslquery']=$this->m_user->detail_user($_POST['user_id']);
		$data['hslqueryb']=$this->m_user->getusergroup();
		$this->load->view('user/formnonaktifkan_user',$data);
	}
	function nonaktifkan_aksi(){
		...
		$ang=explode("*",$_POST['nama_user']);
			...
			$ipp['user_name']=$ang[1];
			$ipp['group_id']=$ang[2];
		$proses = $this->m_user->nonaktifkan_user_aksi($idd,$ipp);
		echo $proses;
	}
///////////////////////////////////////////////////////////////////////////////
	function grup(){
