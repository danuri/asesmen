<div class="row">
	<div class="col-lg-6">
		<div class="panel panel-success">
			<div class="panel-heading">FORM AKTIFKAN PENGGUNA</div>
...
<table class="table table-striped">
        <tr>
          ...
          <td colspan="3">
		  <input type="text" id="nm_pengguna" name="nm_pengguna" class="form-control ipt_text" value="<?=$hslquery[0]->nama_user;?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';" disabled>
		  </td>
        </tr>
        <tr>
          <td>Username</td>
          <td colspan="3">
		  <input type="text" id="user_name" name="user_name" class="form-control ipt_text" value="<?=$hslquery[0]->username;?>" onblur="if(this.value=='') this.value='Wajib diisi';" onfocus="if(this.value=='Wajib diisi') this.value='';" disabled>
		  </td>
        </tr>
        <tr>
          <td>Grup Pengguna</td>
          <td colspan="3">
		  <select id='group_id' name='gorup_id' class="form-control ipt_text" disabled>
       ...
       <tr >
          ...
          <td colspan="3">
				...
				<div onclick="simpan();" class='btn btn-primary btn-sm' id="btAct"><i class="fa fa-bell-o fa-fw"></i> Aktifkan</div>
...
////////////////////////////////////////////////////////////////////////////
	function simpan(){
		...
		if (hasil!=false) {
			...
			$.ajax({
				type:"POST",
				url:"<?=base_url();?>cmsadmin/user/aktifkan_aksi/",
