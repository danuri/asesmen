...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public function getkomen()	{
		...
		$data['pager']= ($dt['count']>0)?Modules::run("crest/pager/pagerA",$dt['count'],$batas,$hal,5):"...";
		echo json_encode($data);
	}
	public function savekomentar()	{
		$this->load->library("form_validation");
		$this->form_validation->set_rules("nama_komentator","NAMA","trim|required");
		$this->form_validation->set_rules("email_komentator","EMAIL","trim|required");
