...
///////////////////////////////////////////////////////////////////////////////////
	public function formfitur($id_widget,$id_kategories,$opsi){
		...
		foreach($data['daftar'] as $it=>$val){
			...
			if(!empty($cek2)){
				...
				$data['daftar'][$it]->slider="<img src='".base_url()."assets/media/artikel_slider/default/no_slider.gif' height=40 border=0>";
			}
		}
	...
	public function form_upload(){
		...
		if(!empty($cek2)){
			...
			$data['dcek'] = "kosong";
			$data['gambar'] = "<img src='".base_url()."assets/media/artikel_slider/default/no_slider.gif' height=80 border=0>";
		}
