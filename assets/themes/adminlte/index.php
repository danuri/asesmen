...
<html>
  <head>
	...
	<script type="text/javascript" src="<?=base_url('assets/js/jquery/jquery-1.11.0.min.js');?>"></script><!--jquery-3.5.1.min.js-->
    <!-- Morris Charts CSS -->
    ...
    <!-- Treeview -->
    <link href="<?=base_url('assets/js/plugins/bootstrap_treeview/public/css/bootstrap-treeview.css');?>" rel="stylesheet">
    <script src="<?=base_url('assets/js/plugins/bootstrap_treeview/public/js/bootstrap-treeview.js');?>"></script>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index2.html" class="logo"><div style="float:left;padding:0px;"><img src="<?=base_url().$logo;?>" style='width:40px;padding-bottom:4px;'> <?=$gr->judul_app;?></div></a>
      ...
      <footer class="main-footer">
        ...
        Copyright &copy; 2023 - whaddupsap&trade; - All Rights Reserved. Page rendered in <strong>{elapsed_time}</strong> seconds
      </footer>
    </div><!-- ./wrapper -->
