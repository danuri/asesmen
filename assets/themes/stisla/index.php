...
<head>
  ...
  <!-- General CSS Files -->
  <link rel="stylesheet" href="<?=base_url('assets/themes/stisla/modules/bootstrap/css/bootstrap.min.css');?>">
  <link rel="stylesheet" href="<?=base_url('assets/themes/stisla/modules/fontawesome/css/all.min.css');?>">

  <!-- CSS Libraries -->
  <link rel="stylesheet" href="<?=base_url('assets/themes/stisla/modules/jqvmap/dist/jqvmap.min.css');?>">
  <link rel="stylesheet" href="<?=base_url('assets/themes/stisla/modules/summernote/summernote-bs4.css');?>">
  <link rel="stylesheet" href="<?=base_url('assets/themes/stisla/modules/owlcarousel2/dist/assets/owl.carousel.min.css');?>">
  <link rel="stylesheet" href="<?=base_url('assets/themes/stisla/modules/owlcarousel2/dist/assets/owl.theme.default.min.css');?>">

  <!-- Template CSS -->
  <link rel="stylesheet" href="<?=base_url('assets/themes/stisla/css/style.css');?>">
  <link rel="stylesheet" href="<?=base_url('assets/themes/stisla/css/components.css');?>">
<!-- Start GA -->
...
<body>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.html">FRKTNG</a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header" style="text-align:center;">==========================</li>
  ...
  <!-- General JS Scripts -->
  <script src="<?=base_url('assets/themes/stisla/modules/jquery.min.js');?>"></script>
  <script src="<?=base_url('assets/themes/stisla/modules/popper.js');?>"></script>
  <script src="<?=base_url('assets/themes/stisla/modules/tooltip.js');?>"></script>
  <script src="<?=base_url('assets/themes/stisla/modules/bootstrap/js/bootstrap.min.js');?>"></script>
  <script src="<?=base_url('assets/themes/stisla/modules/nicescroll/jquery.nicescroll.min.js');?>"></script>
  <script src="<?=base_url('assets/themes/stisla/modules/moment.min.js');?>"></script>
  <script src="<?=base_url('assets/themes/stisla/js/stisla.js');?>"></script>
  
  <!-- JS Libraies -->
  <script src="<?=base_url('assets/themes/stisla/modules/jquery.sparkline.min.js');?>"></script>
  <script src="<?=base_url('assets/themes/stisla/modules/chart.min.js');?>"></script>
  <script src="<?=base_url('assets/themes/stisla/modules/owlcarousel2/dist/owl.carousel.min.js');?>"></script>
  <script src="<?=base_url('assets/themes/stisla/modules/summernote/summernote-bs4.js');?>"></script>
  <script src="<?=base_url('assets/themes/stisla/modules/chocolat/dist/js/jquery.chocolat.min.js');?>"></script>

  <!-- Page Specific JS File -->
  <script src="<?=base_url('assets/themes/stisla/js/page/index.js');?>"></script>
  
  <!-- Template JS File -->
  <script src="<?=base_url('assets/themes/stisla/js/scripts.js');?>"></script>
  <script src="<?=base_url('assets/themes/stisla/js/custom.js');?>"></script>
</body>
</html>
