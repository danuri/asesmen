                        ...
                        <div class="container-fluid" style="padding-bottom:0px;margin-bottom:0px;">
                    			<div class="row" style="padding-bottom:0px;margin-bottom:0px;">
									<div class="col-lg-6" style="padding:0px;">
											...
											<h2 style="padding=0px; float:left;margin:5px 0px 0px 5px;"><?=$gr->judul_app;?></h2>
											<h3 style="padding=0px; float:left;margin:10px 0px 0px 5px;"> - <?=$gr->sub_judul;?></h3>
									</div>
...
?>
                        <ul id="menu" class="bg-bluerr dkerrr">
                ...
                <div id="content">
                    <div class="outer">
                        <div class="inner bg-light lter" style="padding-bottom:380px;margin-top:0px;">
						<?=$konten;?>
                        </div>
                        <!-- /.inner -->
                    </div>
